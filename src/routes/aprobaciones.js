...
router.post('/aprobaciones', isLoggedIn, authRole(['Admincli', 'Plan', 'Cli_C']),async (req, res)=>{
...
router.post('/aprobacionesb', isLoggedIn, authRole(['Cli_B', 'GerVer', 'Cli_A', 'Cli_D', 'Cli_E']), async (req, res)=>{
    const idt = (req.body.idt);
    const Login = req.user.usuario;
    var data = [];
    var est_or= "Terminada validada";
